package com.pabloam.mooc.java8.lesson2;
...
public class Lesson2 {
    ...
    private static final String FILE_PATH   = "lesson2/SonnetI.txt";
    ...
    private void exercise4() throws IOException, URISyntaxException {
        try (BufferedReader reader = Files.newBufferedReader(
                Paths.get(Lesson2.class.getClassLoader().getResource(FILE_PATH).toURI()))) {
